...
$comprobantes = $objCompartido->listarComprobantes1($_SESSION['tipo'],'01');
    ...
    <div class="container-fluid">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">ENVÍO DE FACTURAS ELECTRÓNICAS</h3>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="idemisor" name="idemisor">
                                        ...
                                        <option value="<?php echo $fila['id'];?>"><?php echo $fila['razon_social'];?>
                                        </option>
                                        <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" type="date" name="moneda" id="moneda">
                                        ...
                                        <option value="<?php echo $fila['codigo'];?>"><?php echo $fila['descripcion'];?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div style="display:none; color:green; font-size: 10px;" id="txtTipodoc">El campo es
                                        obligatorio *</div>
                                </div>
                                <div class="form-group">
                                    <label>Serie</label>
                                    <select class="form-control" type="date" name="idserie" id="idserie"
                                        onchange="ConsultarCorrelativo()">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-addon">
                                            <button type="button" class="btn btn-default" id="btnBuscar"
                                                onclick="ObtenerDatosEmpresa()" disabled>
                                                <li class="fa fa-search"></li>
                                            </button>
                                        </div>
                                    </div>
                                    <div style="display:none; color:green; font-size: 10px;" id="txtNrodoc">El campo es
                                        obligatorio *</div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-3" id="pacientes">
                                <div class="form-group">
                                    <label>Nro. Doc</label>
                                    <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input class="form-control" type="text" name="producto" id="producto"
                                        onkeyup="BuscarProducto()" placeholder="producto..." />
                                    <div class="input-group-addon">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <button type="button" class="btn btn-outline-primary btn-block"
                                        onclick="ModalEnvio()"><i class="fa fa-save"></i> S/ <span
                                            id="totalboton">0.00</span></button>
