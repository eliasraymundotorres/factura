...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Envio de Bajas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">ENVÍO DE BAJAS</h3>
              </div>
              <div class="card-body">
<br>
  <div class="form-group row">
			...
			<div class="col-md-2">
				<button class="btn btn-primary" onclick="buscar('01')">Generar</button>
			</div>
		</div>
...
<div align="right" class="col-md-6">
    <button type="button" class="btn btn-outline-danger btn-block" onclick="EnviarResumenComprobantes()"><i class="fa fa-save"></i> Enviar Comprobantes</button>
</div>
<div id="divResultado">
