        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Nota de crédito electrónica</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ENVÍO DE NOTA DE CRÉDITO ELECTRÓNICAS</h3>
              </div>
              <div class="card-body">
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div>
      <button type="button" class="btn btn-outline-primary btn-block" onclick="GuardarNotaCredito()"><i class="fa fa-save"></i> S/ <span id="totalboton">0.00</span></button>
    ...
    if(validar=='') {
        $.ajax({
          ...
          .done(function( html ) {
              ...
              $('#totalboton').html('0.00');
              $('#voucher2').html("<embed src='reportes/ticket_nc.php?id="+html.id+"' type='application/pdf' width='100%' height='600px' />");
              $('#a42').html("<embed src='reportes/comprobante_nc.php?id="+html.id+"' type='application/pdf' width='100%' height='600px' />");
          }); 
